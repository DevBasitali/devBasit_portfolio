...
function Services() {
  return (
    <>
      <section className="relative bg-gray-900 pt-8 pb-8">
        <div className="relative flex flex-col items-center h-screen sm:h-max mx-auto max-w-screen-xl px-4 sm:px-6">
